 ...
 */
static void AddTrans(FwSmDesc_t smDesc, FwSmCounterU2_t transId, FwSmCounterS1_t srcId,
		StateType_t srcType, FwSmCounterS1_t destId, FwSmAction_t trAction, FwSmGuard_t trGuard);
...
void FwSmAddState(FwSmDesc_t smDesc, FwSmCounterS1_t stateId, FwSmCounterS1_t nOfOutTrans,
	...
	smDesc->transCnt = smDesc->transCnt + nOfOutTrans;
